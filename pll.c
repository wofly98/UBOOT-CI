...
void mtk_pll_init(int skip_dcm_setting)
{
	...
	/* Set PLL frequency */
	mmio_write_32(ARMPLL_CON1, 0x30000000); /* 1.3G */
...
mmio_write_32(NET2PLL_CON1, 0x20000000); 
mmio_write_32(MMPLL_CON1, 0x30000000); 
mmio_write_32(NET1PLL1_CON1, 0x28000000); 
