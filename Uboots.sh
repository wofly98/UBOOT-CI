...
SOC=mt7981 BOARD=rfb_spim_nand ./build.sh
...
#SOC=mt7981 BOARD=ruijie_rg-x30e MULTI_LAYOUT=1 ./build.sh
#SOC=mt7981 BOARD=ruijie_rg-x30e-pro MULTI_LAYOUT=1 ./build.sh
